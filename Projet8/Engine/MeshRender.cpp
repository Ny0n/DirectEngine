...
MeshRender::MeshRender(string fileName)
{
}
...
void MeshRender::Update(float runTime, float deltaTime)
{
    Render();
    Placement();
...
void MeshRender::Render()
{
    ...
    if (FAILED(D3DXLoadMeshFromX(L"C:\\Users\\fcalvet\\Desktop\\direct8\\Projet8\\RollerCoaster\\Mesh\\tiger.x", D3DXMESH_SYSTEMMEM, d3ddev, NULL, &pMtrlBuffer, NULL, &g_dwNumMaterials, &_pmesh))) {
        MessageBox(0, L"load mesh fail ", 0, 0);
        return;
    }
}

void MeshRender::Placement()
{
